...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  <thead>
    <tr>
      <th colspan="2" style="padding: 0; border: none;"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /><h3>Security &amp; Cryptography</h3><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /></th>
    </tr>
  </thead>
  <tbody>
    <tr valign="top">
...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  <thead>
    <tr>
      <th colspan="2" style="padding: 0; border: none;"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /><h3>Audio &amp; Voice</h3><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /></th>
    </tr>
  </thead>
  <tbody>
    <tr valign="top">
...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  <thead>
    <tr>
      <th colspan="2" style="padding: 0; border: none;"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /><h3>AI &amp; Data Science</h3><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /></th>
    </tr>
  </thead>
  <tbody>
    <tr valign="top">
...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  <thead>
    <tr>
      <th colspan="2" style="padding: 0; border: none;"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /><h3>Developer Tools</h3><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /></th>
    </tr>
  </thead>
  <tbody>
    <tr valign="top">
...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  <thead>
    <tr>
      <th colspan="2" style="padding: 0; border: none;"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /><h3>Web &amp; Accessibility</h3><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /></th>
    </tr>
  </thead>
  <tbody>
    <tr valign="top">
...
<table width="100%" border="0" cellspacing="0" cellpadding="12">
  <thead>
    <tr>
      <th colspan="2" style="padding: 0; border: none;"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /><h3>Other</h3><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" width="1000px" height="0px" style="max-width: 100%; display: block;" /></th>
    </tr>
  </thead>
  <tbody>
    <tr valign="top">
      <td width="50%" valign="top"><div align="center"><h3><a href="https://github.com/YaronKoresh/secure-caesar" target="_blank">Secure Caesar</a></h3><p><img src="https://img.shields.io/badge/Stars-1-yellow?style=flat-square" alt="1 stars"/> &nbsp; <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black" alt="JavaScript"/></p><p><em>secure-caesar cipher, is a symetric key cipher, based on caesar shift cipher. Enhanced with unicode support, custom padding, Scrypt key expander, elliptic curve support & power usage selection.</em></p></div></td>
    ...
    <tr valign="top">
      ...
      <td width="50%" valign="top"><div align="center"><h3><a href="https://github.com/YaronKoresh/gesher" target="_blank">Gesher</a></h3><p><img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black" alt="JavaScript"/></p><p><em>A secure, pure-Python HTTP tunnel to expose local services to the internet.</em></p></div></td>
    </tr>
    <tr valign="top">
...
<p align="center">
  <sub>Last updated: September 23, 2026 &nbsp;&middot;&nbsp; Generated automatically from GitHub API &nbsp;&middot;&nbsp; <a href="https://github.com/YaronKoresh/YaronKoresh/actions">View Workflow</a></sub>
</p>
